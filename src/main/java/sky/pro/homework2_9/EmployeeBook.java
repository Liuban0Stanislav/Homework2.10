...
import sky.pro.homework2_9.execptions.FullMapException;
import sky.pro.homework2_9.execptions.IsAlfaException;
import sky.pro.homework2_9.execptions.IsMixedCaseException;
...
public class EmployeeBook {
    ...
    public void addEmployee(String fullName, int salary, int dept) {
        ...
        if(!StringUtils.isMixedCase(fullName)){
            throw new IsMixedCaseException();
        }
